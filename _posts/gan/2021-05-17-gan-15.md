...
- Paper : [StyleCLIP: Text-Driven Manipulation of StyleGAN Imagery](https://arxiv.org/abs/2103.17249) (2021 /Or Patashnik, Zongze Wu, Eli Shechtman, Daniel Cohen-Or, Dani Lischinski)
...
**3.1 Latent Optimization**은 이미지 조작은 잘 하지만, 이미지를 조작하려면 single image마다 몇분의 optimization과정이 필요하기 때문에 여러장의 이미지를 학습시키기엔 시간이 너무 오래걸린다. 또한, $\lambda$ 와 같은 parameter에 sensitive하다.
