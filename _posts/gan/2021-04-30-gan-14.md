...
<p align='center'><img src='https://github.com/happy-jihye/happy-jihye.github.io/blob/master/_posts/images/gan/munit1.PNG?raw=1' width = '450' ></p>
...
1. 이미지를 우선 **content code와 style code**로 decompose한다.
  <p align='center'><img src='https://github.com/happy-jihye/happy-jihye.github.io/blob/master/_posts/images/gan/munit2.PNG?raw=1' width = '600' ></p>

  - <span style='background-color: #E5EBF7;'> **content code** </span>는 domain-invariant(domain-shared)한 이미지의 attribute에 대한 정보를 담고 있는 code으로, 모든 domain의 이미지들은 content space $\mathcal{C}$ 를 공유한다.
