...
<p align="center"><img src="https://github.com/happy-jihye/happy-jihye.github.io/blob/master/_posts/images/gan/gan1.PNG?raw=1" width = "600" ></p>
...
> 
> G가 실제 data distribution을 잘 따라가도록 학습이 된다면, optimal G는 $p_g = p_data$가 됩니다.
> 
> 즉, D와 G가 모두 optimal 하다면 $D(\boldsymbol{x})=\frac{1}{2}$

### Object Functions

<p align="center"><img src="https://github.com/happy-jihye/happy-jihye.github.io/blob/master/_posts/images/1_GAN_files/gan4.png?raw=1" width = "700" ></p>

- GAN을 수식으로 표현하면 다음과 같으며, `minimax game`의 global optimum에 도달하면 **D**는 $D_G(x)={p_{data}(x)}/{p_{data}(x)+p_{g}(x)}$가 되며, **G**는 $p_{data}(x)=p_{g}(x)$ 가 됩니다.
