...
2개 이상의 domain을 다루는 image-to-image translation 연구들은 **scalbility와 robustness**에 한계가 있었다. StarGAN은 이를 개선하여 single network로 Multi-Domain에 대해 이미지 변환을 할 수 있게 했고, flexible하고 scalable하다는 장점이 있다.

## 1. Introduction

<p align='center'><img src='https://github.com/happy-jihye/happy-jihye.github.io/blob/master/_posts/images/gan/stargan1.PNG?raw=1' width = '700' ></p>
...
<font color="gray" font-size = "small"><i> StarGAN에서는 single generator를 사용해서 다양한 domain을 mapping한다. : ⭐별모양⭐ </i></font>
