...
<p align="center"><img title = "img" src="https://miro.medium.com/max/2332/1*8dx6nxpUh2JqvYWPadTwMQ.gif)

다음은 filter가 어떻게 슬라이딩을 하면서 input값을 처리하는지를 그림으로 나타낸 예제입니다.

<p align="center"><img title = "img" src="https://miro.medium.com/max/535/1*Zx-ZMLKab7VOCQTxdZ1OAw.gif)
...
<p align="center"><img title = "img" src="https://miro.medium.com/max/395/1*1okwhewf5KCtIPaFib4XaA.gif)
