...
- Example Dataset : *CIFAR10* 
  ...
  - ![](/_posts/cs231n/images/lec2/image-20210303173804674.png){: width="80%", height="80%"}{: .center}
- 정확하지 않게 분류되는 것도 많음
...
> - ![](/_posts/cs231n/images/lec2/image-20210303175236169.png){: width="80%", height="80%"}{: .center}
...
> #### *NN알고리즘을 실제로 적용하면?* 
>
> ![](/_posts/cs231n/images/lec2/image-20210305172021148.png){: width="80%", height="80%"}{: .center}
>
...
![](/_posts/cs231n/images/lec2/image-20210305190849027.png){: width="80%", height="80%"}{: .center}
...
> #### Distance Metric
>
> ![image-20210305191436399](/_posts/cs231n/images/lec2/image-20210305191436399.png){: width="80%", height="80%"}{: .center}
>
...
>
> ![](/_posts/cs231n/images/lec2/image-20210305191932390.png){: width="80%", height="80%"}{: .center}
>
...
- ![](/_posts/cs231n/images/lec2/image-20210305194252917.png){: width="80%", height="80%"}{: .center} 
...
- #### idea 4 : Cross-Validation
  ...
  - ![image-20210305194555149](/_posts/cs231n/images/lec2/image-20210305194555149.png){: width="80%", height="80%"}{: .center}
...
>   - ![image-20210305200123067](/_posts/cs231n/images/lec2/image-20210305200123067.png){: width="80%", height="80%"}{: .center}
...
![image-20210305201007375](/_posts/cs231n/images/lec2/image-20210305201007375.png){: width="80%", height="80%"}{: .center}
...
![image-20210305201202039](/_posts/cs231n/images/lec2/image-20210305201202039.png){: width="80%", height="80%"}{: .center}

- 데이터셋이 불균형한 경우(ex, 개보다 고양이 데이터가 많을 때) 고양이 클래스에 해당하는 바이어스가 커지게 됨.
- ![](/_posts/cs231n/images/lec2/image-20210305201807926.png){: width="80%", height="80%"}{: .center}
...
- 가중치 벡터를 시각화한것
  ...
  ![image-20210306095327199](/_posts/cs231n/images/lec2/image-20210306095327199.png){: width="80%", height="80%"}{: .center}

- Linear classifier : 고차원 공간에 선형적인 경계를 그어 이미지를 분류하는 것

  ![image-20210306095626711](/_posts/cs231n/images/lec2/image-20210306095626711.png){: width="80%", height="80%"}{: .center}
...
>
> ![image-20210306095757349](/_posts/cs231n/images/lec2/image-20210306095757349.png){: width="80%", height="80%"}{: .center}
