...
<details>
<summary> **Transfer Learning 설명 (출처 : [simonjisu/FARM_tutorial](https://github.com/simonjisu/FARM_tutorial) )** </summary>
...
- <details> 
  <summary> Appendix D.3 </summary>
    실험에서는 4가지의 positional embedding 방식을 비교했다.

    1. **No positional information** : input이 *bag of patches*와 같다
