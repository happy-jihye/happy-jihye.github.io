---
title: "1 - Generative Adversarial Networks(GAN)"
excerpt: "Generative Adversarial Networks(GAN)은 adversarial process를 적용한 생성모델입니다. 주어진 입력 데이터와 유사한 데이터를 생성하는 것을 목표로 하며, Generator model과 Discriminative model이 경쟁하며 서로의 성능을 높여가는 재미있는 모델입니다. "
...
![](https://github.com/happy-jihye/GAN/blob/main/images/gan1.png?raw=1){: width="50%", height="50%"}
...
![png](/assets/imgaes/1_GAN_files/1_GAN_7_3.png?raw=1){: width="50%", height="50%"}
...
![](https://github.com/happy-jihye/GAN/blob/main/images/gan4.png?raw=1){: width="50%", height="50%"}
...
![](https://github.com/happy-jihye/GAN/blob/main/images/gan2.png?raw=1){: width="50%", height="50%"}
...
![png](/assets/imgaes/1_GAN_files/1_GAN_22_0.png?raw=1){: width="50%", height="50%"}
